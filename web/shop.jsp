<%-- 
    Document   : shop
    Created on : May 29, 2023, 10:34:40 AM
    Author     : szxcr
--%>
...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__option">
            <ul>
                <li><a href="#"> </a> <span class="arrow_carrot-down"></span></li>
            </ul>
        </div>
    </div>
    <header class="header">
                ...
                <div class="col-lg-12">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li><a href="shoping-cart.jsp">Checkout</a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            <h6><a href="shop-details.jsp">Dozen Cupcakes</a></h6>
                            <div class="product__item__price">RS 320.00</div>
                            <div class="cart_add">
                                <a href="shoping-cart.jsp">Proceed to Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <div class="product__item__price">RS 400.00</div>
                            <div class="cart_add">
                                <a href="shoping-cart.jsp">Proceed to Checkout</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <div class="product__item__price">RS 310.00</div>
                            <div class="cart_add">
                                <a href="shoping-cart.jsp">Proceed to Checkout</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <div class="product__item__price">RS 250.00</div>
                            <div class="cart_add">
                                <a href="shoping-cart.jsp">Proceed to Checkout</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <div class="product__item__price">RS 500.00</div>
                            <div class="cart_add">
                                <a href="shoping-cart.jsp">Proceed to Checkout</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <div class="product__item__price">RS 150.00</div>
                            <div class="cart_add">
                                <a href="shoping-cart.jsp">Proceed to Checkout</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <div class="product__item__price">RS 350.00</div>
                            <div class="cart_add">
                                <a href="shoping-cart.jsp">Proceed to Checkout</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <div class="product__item__price">RS 550.00</div>
                            <div class="cart_add">
                                <a href="shoping-cart.jsp">Proceed to Checkout</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <div class="product__item__price">RS 260.41</div>
                            <div class="cart_add">
                                <a href="shoping-cart.jsp">Proceed to Checkout</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <div class="product__item__price">RS 220.00</div>
                            <div class="cart_add">
                                <a href="shoping-cart.jsp">Proceed to Checkout</a>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="footer__widget">
                        ...
                        <ul>
                            ...
                            <li>Sunday: 10:00 am – 17:00 pm</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <p>When it comes to desserts, cake probably “takes the cake” for being the champion of sweetness and goodness. I love it; you love it; everyone loves it!</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="footer__newslatter">
                        <h6>Happiness starts here.</h6>
                        <p>"Savor Heavenly Cake Creations!"</p>
                        <div>
